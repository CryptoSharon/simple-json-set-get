 ...
 * @returns {any}
 */
const getValueAtKeyPath = (obj, keyPath) => {
  const keys = keyPath.split(/\./);
 ...
 * @param {any} value
 */
const setValueAtKeyPath = (obj, keyPath, value) => {
  const keys = keyPath.split(/\./);
 ...
 * @param {string} keyPath
 */
const deleteValueAtKeyPath = (obj, keyPath) => {
  const keys = keyPath.split(/\./);
...
export { hasKeyPath, setValueAtKeyPath, getValueAtKeyPath, deleteValueAtKeyPath }